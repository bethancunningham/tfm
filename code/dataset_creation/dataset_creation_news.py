...
def make_incorrect_sentence(row) :
    ...
    def find_matches(context) :
        """Function to search for word plus its context to ensure the correct occurrence of the word. Returns matches.""" # Needed because sometimes the word appears more than once in the sentence - need to make sure the right one is being replaced
